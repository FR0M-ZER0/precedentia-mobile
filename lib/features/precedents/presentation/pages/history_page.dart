...
class HistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BasePageTemplate(
      ...
      subtitle:
          'Acesse rapidamente as petições e precedentes visualizados anteriormente',
      ...
      body: ValueListenableBuilder(
        ...
        valueListenable: Hive.box<PrecedentModel>(
          'accessed_precedents',
        ).listenable(),
        builder: (context, Box<PrecedentModel> box, _) {
          ...
          return ListView.separated(
            shrinkWrap: true,
            physics:
                const NeverScrollableScrollPhysics(), // O scroll fica por conta do BasePageTemplate
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.altLightColor.withValues(
                    alpha: 0.3,
                  ), // Fundo bem clarinho pro lado direito
